...
async def start(client, message):
    ...
    if await check_user_joined_channels(client, user_id, config.REQUIRED_CHANNEL_IDS):
        welcome_message = (
            ...
            "**☞ Rᴇɢɪsᴛᴇʀ Wɪᴛʜ https://55club01.in/#/register?invitationCode=56414100388**\n\n"
            "**👋 Eᴀʀɴ Dᴀɪʟʏ 2000₹-5000₹ Vɪᴀ Pʟᴀʏɪɴɢ Eᴀsʏ Gᴀᴍᴇs💰**\n\n"
            "**ᴛʜᴀɴᴋ ʏᴏᴜ 😘😘**\n"
            "**────────────────────────────**"
        )
          
        photo_url = "https://telegra.ph/file/99dfcd85bf2478a2fc971.jpg"
        reply_markup = InlineKeyboardMarkup([
            [InlineKeyboardButton("ʀᴇᴄʜᴀʀɢᴇ / ᴡɪᴛʜᴅʀᴀᴡᴀʟ ɪꜱꜱᴜᴇ", url="https://t.me/Diyasupports")],
            [InlineKeyboardButton("ᴠɪᴘ ᴄʜᴀɴɴᴇʟ", url="https://t.me/+Y3ssDlpvvQEyNDJl")],
